...
const anymatch_1 = __importDefault(__nccwpck_require__(575));
const fs_1 = __importDefault(__nccwpck_require__(747));
const readline = __importStar(__nccwpck_require__(58));
class Matcher {
    constructor(props) {
        this.props = props;
    }
...
const match_1 = __nccwpck_require__(942);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
const normalizePath = __nccwpck_require__(388);
